// Interfaces de mappers - DESHABILITADAS temporalmente
// Estas interfaces dependen de base entities que requieren módulos de auditoría no disponibles en el template base
// Descomenta y configura cuando necesites estas funcionalidades avanzadas
